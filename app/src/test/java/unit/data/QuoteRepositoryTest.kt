...
class QuoteRepositoryTest {
    ...
    @Test
    fun `loadQuotesForBook should call repository and update quotes state`() = runTest {
        val bookId = "book-1"
        val quotes = listOf(
            QuoteEntity(
                id = "q1",
    ...
    @Test
    fun `loadAllQuotes should call repository and update allQuotes state`() = runTest {
        val quotes = listOf(
            QuoteEntity(
                id = "q1",
                bookId = "book-1",
    ...
    @Test
    fun `addQuote should insert quote and refresh both quotes and allQuotes`() = runTest {
        val bookId = "book-1"
    ...
    @Test
    fun `updateQuote should delegate to repository and refresh quotes`() = runTest {
        val bookId = "book-1"
    ...
    @Test
    fun `deleteQuote should delegate to repository and refresh quotes`() = runTest {
        val bookId = "book-1"
        val quote = QuoteEntity(
            id = "q1",
            bookId = bookId,
